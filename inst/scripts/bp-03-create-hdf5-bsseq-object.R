...
# Saving BSseq object (column wise)
files_bsseq_hdf5_col <- file.path(dataPath, "files_bsseq_hdf5_col")
saveHDF5SummarizedExperiment(bs, files_bsseq_hdf5_col, replace = TRUE,
                             chunkdim = c(1e6, 1), verbose = TRUE)

# Saving BSseq object (row wise)
files_bsseq_hdf5_row <- file.path(dataPath, "files_bsseq_hdf5_row")
saveHDF5SummarizedExperiment(bs, files_bsseq_hdf5_row, replace = TRUE,
                             chunkdim = c(1e4, ncol(bs)), verbose = TRUE)
